    ...
    <>
      ...
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8">
        <div className="flex flex-col gap-10 text-sm leading-relaxed text-stone">
          <section>
            <h2 className="mb-3 t-subheading text-ink">Angaben gemäß § 5 DDG (Platzhalter)</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 t-subheading text-ink">Kontakt</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 t-subheading text-ink">Vertretungsberechtigt</h2>
            <p>Mara Lindqvist (fiktive Geschäftsführung, Platzhaltername)</p>
          </section>

          <section>
            <h2 className="mb-3 t-subheading text-ink">Umsatzsteuer-Identifikationsnummer</h2>
            <p>DE 000 000 000 (Platzhalter, keine reale USt-IdNr.)</p>
          </section>

          <section>
            <h2 className="mb-3 t-subheading text-ink">
          ...
          <section>
            <h2 className="mb-3 t-subheading text-ink">EU-Streitschlichtung</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 t-subheading text-ink">Bildnachweise</h2>
            <p>
